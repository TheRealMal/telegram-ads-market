...
type Config struct {
	...
	MarketTransactionGasTON float64                 `env:"MARKET_TRANSACTION_GAS_TON" env-default:"0.1"`
	MarketCommissionPercent float64                 `env:"MARKET_COMMISSION_PERCENT" env-default:"2"`
}
